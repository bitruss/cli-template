...
func InitElasticSearch() (*elasticsearch.Client, error) {
	...
	elasticsearch_addr, elasticsearch_addr_err := cliCmd.Config.GetString("elasticsearch_addr", "")
	...
	elasticsearch_username, elasticsearch_username_err := cliCmd.Config.GetString("elasticsearch_username", "")
	...
	elasticsearch_password, elasticsearch_password_err := cliCmd.Config.GetString("elasticsearch_password", "")

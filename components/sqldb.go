...
func InitDB() (*gorm.DB, *sql.DB, error) {
	...
	GormDB, errOpen := gorm.Open(mysql.Open(dsn), &gorm.Config{
		Logger: New_gormLocalLogger(cli.Logger),
	})
...
type gormLocalLogger struct {
	LocalLogger           *ULog_logrus.LocalLog
	SlowThreshold         time.Duration
	SourceField           string
	SkipErrRecordNotFound bool
}

func New_gormLocalLogger(localLogger *ULog_logrus.LocalLog) *gormLocalLogger {
